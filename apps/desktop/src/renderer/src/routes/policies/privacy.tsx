    ...
    <AuthenticationWrapper pageType={EPageTypes.PUBLIC}>
      <div className="flex flex-col justify-center items-center my-8 max-w-3xl mx-auto">
        <div className="mx-auto prose prose-sm/loose lg:prose-lg/loose dark:prose-dark">
          ...
          <p className="mb-4">
            At CodeVault LLC, we respect your privacy. This Privacy Policy
          ...
          <p className="mb-4">
            We collect certain non-sensitive data, including:
          </p>
          <ul className="list-disc list-inside mb-4">
            <li>
              Basic user information (name, email, etc.) during registration.
            </li>
          ...
          <p className="mb-4">
            We take reasonable security measures to protect your data, but we
          ...
          <p className="mb-4">
            We do not sell your data to third parties. Some features may rely on
            third-party integrations, which have their own privacy policies.
          </p>
          ...
          <p className="mb-4">
            ...
            of Manager after updates means acceptance of the new policy.
          </p>

          <h2 className="text-xl font-semibold mt-6">7. Contact</h2>
          <p className="mb-4">
            If you have any questions, contact us at privacy@codevaultllc.com.
          </p>
        </div>
