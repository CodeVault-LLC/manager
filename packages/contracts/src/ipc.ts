...
import type { DeviantArtMediaState } from "./deviantart.ts";
...
export interface ServerConfig {
  ...
  /** Last cached DeviantArt media feed and imported collections. */
  deviantartMedia: DeviantArtMediaState;
}

export type ConnectIntegrationStatus = "started" | "completed";

export type ConnectIntegrationLaunchMode =
  | "default-browser"
  | "custom-browser"
  | "copy-url";

export interface ConnectIntegrationOptions {
  /** How to launch the OAuth URL after it is generated. */
  launchMode?: ConnectIntegrationLaunchMode;
  /** Browser command used only when launchMode is "custom-browser". */
...
export interface ConnectIntegrationResult {
  ...
  /** OAuth URL generated by the integration flow (safe to copy for user action). */
  authUrl?: string;
...
export interface DesktopBridge {
  ...
  /** Return cached DeviantArt media state without forcing network calls. */
  getDeviantArtMediaState: () => Promise<DeviantArtMediaState>;

  /** Force an immediate DeviantArt sync and return the latest cached state. */
  refreshDeviantArtMediaState: () => Promise<DeviantArtMediaState>;
}
