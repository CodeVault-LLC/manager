...
export const PremierLeague: FC<BrandIconProps> = (props) => {
  return (
    <svg
      {...props}
      version="1.1"
      ...
      x="0px"
      y="0px"
      viewBox="0 0 67.7 86.2"
      data-enable-background="new 0 0 67.7 86.2"
    >
      <g>
        <path
          className="st0"
          style={{ fill: '#360D3A' }}
          d="M13.4,7.1c3.8,1.8,6.3,4,6.7,4.3c-0.2-1-0.9-5.7-1.4-8.6c2.2,1.5,7.4,5.1,9.1,6.3C28.4,7,30.9,0,30.9,0
